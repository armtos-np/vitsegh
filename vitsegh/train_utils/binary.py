...
from vitsegh.train_utils.utils import generate_binary_test_metrics, generate_binary_inference
from vitsegh.utils.path import save_model
...
def binary_segmentation_inference(
    rank: int,
    model: torch.nn.Module,
    dataloaders: dict[torch.nn.Module],
    output_path: str,
    ...
    generate_binary_inference(model, dataloaders["test"], device, output_path)
