...
from vitsegh.dataset import VitseghDataset
from vitsegh.train_utils.scale import get_band_norm_values_from_root
from vitsegh.train_utils.transforms import (
    get_test_transforms,
...
def get_dataloader(rank: int, world_size: int, config: TrainingConfig) -> dict:
    if config.dataset == "vitsegh":
        return get_vitsegh_dataloaders(rank, world_size, config)
    else:
